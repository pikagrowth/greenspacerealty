...
export default function TermsConditionsPage() {
  return (
    <div className="w-full bg-white dark:bg-brand-bgDark py-20 md:py-24 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="mb-12 border-b border-gray-200 dark:border-gray-800 pb-8 transition-colors">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4 tracking-tight transition-colors">
            Terms & Conditions
          </h1>
          <p className="text-gray-500 dark:text-gray-400 transition-colors">Last Updated: November 2023</p>
        </div>

        <div className="prose prose-lg prose-blue dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 transition-colors">
          
          <div className="bg-brand-alert/10 dark:bg-brand-alertDark/10 border-l-4 border-brand-alert dark:border-brand-alertDark p-4 mb-8 text-sm text-gray-900 dark:text-gray-200 rounded-r-lg transition-colors">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">1. Nature of Services</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">2. Accuracy of Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">3. Use of Financial Tools</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">4. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">5. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">6. Indemnification</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">7. Governing Law & Jurisdiction</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">8. Contact Details</h2>
