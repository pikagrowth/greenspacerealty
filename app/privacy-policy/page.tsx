    ...
    <div className="w-full bg-white dark:bg-brand-bgDark py-20 md:py-24 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg prose-blue dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 transition-colors">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">1. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">3. Data Sharing and Third Parties</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">4. Cookies and Local Storage</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">5. Financial Calculators and Tools</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">6. RERA Disclaimer</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-10 mb-4 transition-colors">7. Contact Us</h2>
