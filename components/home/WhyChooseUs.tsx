  ...
  const pillars = [
    {
      ...
      icon: <MapPin className="w-6 h-6 text-brand-primary dark:text-brand-primaryDark transition-colors" />
    },
    {
      ...
      icon: <ShieldCheck className="w-6 h-6 text-brand-primary dark:text-brand-primaryDark transition-colors" />
    },
    {
      ...
      icon: <Handshake className="w-6 h-6 text-brand-primary dark:text-brand-primaryDark transition-colors" />
    },
    {
      title: "Zero Hidden Costs",
      description: "What we quote is what you pay. We pride ourselves on absolute financial transparency before you commit.",
      icon: <Eye className="w-6 h-6 text-brand-primary dark:text-brand-primaryDark transition-colors" />
    },
    {
      ...
      icon: <Briefcase className="w-6 h-6 text-brand-primary dark:text-brand-primaryDark transition-colors" />
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/3 text-left">
            ...
            <div className="relative h-64 md:h-80 w-full rounded-2xl overflow-hidden shadow-lg hidden lg:block border border-gray-100 dark:border-gray-800 transition-colors">
              <img 
          ...
          <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
            {pillars.map((pillar, idx) => (
              <div key={idx} className="flex gap-4">
                <div className="w-12 h-12 bg-white dark:bg-[#1a1e1b] rounded-full shadow-sm border border-gray-100 dark:border-gray-800 flex items-center justify-center shrink-0 transition-colors">
                  {pillar.icon}
                </div>
                <div>
                  <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2 transition-colors">{pillar.title}</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed transition-colors">{pillar.description}</p>
                </div>
              </div>
            ))}
          </div>
