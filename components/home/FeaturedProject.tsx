    ...
    <section className="py-24 bg-gray-50 dark:bg-[#0c100e] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <Link href="/projects/shravan-siddhant" className="shrink-0">
        ...
        <div className="bg-white dark:bg-[#111412] rounded-[40px] shadow-2xl overflow-hidden grid lg:grid-cols-2 gap-0 border border-gray-200 dark:border-gray-800 transition-colors duration-300 group">
          
          {/* Left: Image Container */}
          <div className="relative h-[400px] lg:h-auto w-full overflow-hidden bg-gray-100 dark:bg-gray-900">
            <Image
            ...
            <div className="absolute bottom-6 left-6 z-10 bg-white/90 dark:bg-black/80 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/20">
              <div className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Starting Price</div>
              <div className="text-2xl font-black text-brand-primary dark:text-brand-primaryDark">₹85 Lacs*</div>
            </div>
          </div>
          ...
          <div className="p-10 md:p-14 flex flex-col justify-center relative">
            ...
            <div className="absolute top-0 right-0 w-32 h-32 bg-brand-primary/5 rounded-bl-[80px] -z-0"></div>
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white mb-6 transition-colors tracking-tight">
                Shravan Siddhant
              </h3>
              
              <p className="text-gray-600 dark:text-gray-400 mb-10 leading-relaxed text-lg transition-colors font-light">
              ...
              <div className="grid grid-cols-2 gap-8 mb-10 border-t border-gray-100 dark:border-gray-800 pt-8">
                <div>
                  <div className="flex items-center gap-2 mb-2 text-gray-400">
                    <Building2 size={16} />
                    <span className="text-xs font-bold uppercase tracking-wider">Configuration</span>
                  </div>
                  <div className="text-lg font-extrabold text-gray-900 dark:text-white transition-colors">2 & 3 BHK, Shops</div>
                </div>
                <div>
                  <div className="flex items-center gap-2 mb-2 text-gray-400">
                  ...
                  <div className="text-lg font-extrabold text-brand-alert dark:text-brand-alertDark transition-colors">Limited Units Left</div>
                </div>
              </div>
